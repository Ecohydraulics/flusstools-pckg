...
def create_raster(file_name, raster_array, bands=1, origin=None, epsg=4326, pixel_width=10., pixel_height=10.,
    ...
    Args:
        ...
        raster_array (``ndarray`` or ``list``): Array (*must be 2D array only, no bands) or list of arrays of values to rasterize. If a list of arrays is provided, the length of the list will correspond to the number of bands added to the raster (supersedes ``bands``).
